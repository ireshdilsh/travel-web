    ...
    <div>
      ...
      <section id="plan-your-trip">
        ...
        <div className="planned-body">
          ...
          <div className="form">
            <div className="title">
              <h3>Let’s Plan Your Adventure</h3>
              ...
              <div className="body">
                ...
                <div className="member-count">
                  ...
                  <select class="form-select" aria-label="Default select example">
                    <option selected>Open this select the travelers</option>
            ...
            <div className="travel-info">
              <div className="title">
                ...
                <p>Provide the key information about your trip — where you're going, when you're leaving, and how long you'll be staying.</p>
              </div>
              <div className="body">
                <div className="set-1">
                  <div className="name">
